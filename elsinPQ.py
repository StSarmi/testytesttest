...
#	'battery' deliver all the following:
#		<7029> Temperature		- one value read every 1 min for 'battery temperature'
#		<7030> SoC				- one value read every 1 min for avg SoC of the battery
#		<7031> Current			- one value read every 1 min for avg current to/from the battery
#		<7032> Voltage			- one value read every 1 min for avg 'battery voltage'
#		<7057> SoH				- one value read every 1 min for SoH of the battery
#
#	'xtenders' deliver all the following:
...
#
#	Time						- the time and date of the last value updated
#
#	Sikker utkobling:
#		<meter> ACL1/2/3		- one value read every second via modbus RTU, per phase
#		<meter> ACbreaker 		- one value written to IO to open or close safety breaker for power supply   
#
#	MVB:
#		<MVB> ValueL1/2/3		- one value read every minute via CANbus, lift from 0-100%
#
###########################################################################################################
